...
2. **Sentence Transformer + Logistic Regression BERT**:
...
├── processor_bert.py       # BERT model loading + inference
├── processor_llm.py        # LLM-based classifier
├── regex_processor.py      # Regex rules
├── bert_regr_model.pkl     # Trained BERT regression model
├── resources/
